...
LoadingJS.prototype = {
  initConfig: function () {
    try {
      this.loadingCaption = bookConfig.loadingCaption
        ...
        : document.title;
      this.loadingCaptionFontSize = !isNaN(bookConfig.loadingCaptionFontSize)
        ? parseInt(bookConfig.loadingCaptionFontSize)
        : 28;
      ...
      this.loadingPictureHeight = !isNaN(bookConfig.loadingPictureHeight)
        ? parseInt(bookConfig.loadingPictureHeight)
        : 150;
      this.loadingDisplayTime = !isNaN(bookConfig.loadingDisplayTime)
        ? parseInt(bookConfig.loadingDisplayTime)
        : 0;
      this.loadingSpacing = !isNaN(bookConfig.loadingSpacing)
        ? parseInt(bookConfig.loadingSpacing)
        : 20;
      this.showLoadingGif =
        bookConfig.showLoadingGif != undefined
          ? parseBool(bookConfig.showLoadingGif, true)
          : true;
      this.loadingVideo = bookConfig.loadingVideo
  ...
  loadingSvg: function () {
    ...
    var loadImageUrl = document.createElementNS(
  ...
  initCss: function () {
    ...
    var loadingBoxTran =
      "translate(-50% , -" + (this.loadingSpacing / 2 + 45) + "px)";
    var videoImageTran =
      "translate(-50% , -" + (this.loadingSpacing / 2 + 60) + "px)";
    // var videoLoadImageTran = "translate(-50% , -" + (this.loadingSpacing/2 + 60) + "px)";
    var imageTran = "translate(-50% , 0)";
    var imageTop = "5%";
    var imageDisplay = "block";

    var loadingPictureHeight = Math.min(
    ...
    if (this.showLoadingGif || this.loadingVideo) {
      ...
      imageTran =
        "translate(-50% , -" +
        (this.loadingSpacing / 2 + loadingPictureHeight) +
        "px)";
    }
    ...
    if (this.videoLoadImage)
      this.videoLoadImage.style["margin-bottom"] =
        this.loadingSpacing / 2 + "px";
